<!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="manage_user.php"><i class="fa fa-fw fa-user"></i> Manage Users</a>
                    </li>
                   <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#reports"><i class="fa fa-fw fa-bar-chart-o"></i> Reports</a>
                        <ul id="reports" class="collapse">
                            <li>
                                 <a href="#"><i class="fa fa-fw fa-inr"></i>Sales Report</a>
                            </li>
                            <li>
