...
if(isset($_REQUEST['txtEmail']) && isset($_REQUEST['txtPassword'])){
		...
		//echo $e_password; die();
		//$query = "UPDATE admin_user SET admin_pass='$e_password' WHERE admin_user_id=2 "; die();
		$query = "select * from admin_user where admin_email='$email' and admin_pass='$e_password' and admin_status=1";
		...
		if(mysql_num_rows($result)>0){
			...
			$update_query = "update admin_user set lastlogin ='$lastlogin' where admin_user_id='$user_id'";
		...
		<div class="container-fluid">
			<div class="col-lg-12">
				...
				<table border='0' align="center">
					...
					<tr>
						<td colspan="2"><br><center><input type="submit" name="submit" value="Login" class="btn btn-primary btn-lg" href="pages/home.php" ></center></td>
					</tr>
					<tr>
						<td colspan="2"><br><center><a href="forgot_password.php"> Forgot password?</a></center></td>
					</tr>
				</table>
			</form>
			</div>
